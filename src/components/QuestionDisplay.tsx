...
// const QuestionDisplay = ({ test, onSubmit, disabled = false, answerResult }: QuestionDisplayProps) => {
//   const [selectedOptions, setSelectedOptions] = useState<number[]>([]);
//   const [codeAnswer, setCodeAnswer] = useState<string>('');
//   const [submittedOptions, setSubmittedOptions] = useState<number[]>([]);
...
//     if (answerResult) return; // Блокируем изменения после отправки ответа
...
//     const isSelected = submittedOptions.includes(optionId);
...
//                 <Checkbox
//                   checked={answerResult ? submittedOptions.includes(option.id) : selectedOptions.includes(option.id)}
